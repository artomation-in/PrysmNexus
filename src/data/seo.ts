export const brand = {
  ...
  region: "Telangana",
  country: "IN",
  description: "PrysmNexus is a Hyderabad growth marketing agency combining brand strategy, original content, social media, performance marketing, SEO, local search, and reputation support under one accountable team.",
  reviewed: "2026-07-16",
};
...
export const services: Service[] = [
  {
    ...
    title: "Brand strategy for Hyderabad businesses that want to be remembered.",
    description: "Brand strategy, positioning, messaging, and visual identity for Hyderabad restaurants, cafés, venues, and growing local businesses.",
  ...
  },
  {
    ...
    description: "Original photography, videography, reels, creative copy, and campaign content production for Hyderabad brands and hospitality businesses.",
  ...
  },
  {
    ...
    description: "Social media strategy, content calendars, publishing, page handling, community engagement, WhatsApp marketing, and reporting in Hyderabad.",
  ...
  },
  {
    ...
    description: "Performance marketing, Google Ads, Meta Ads, lead generation, campaign creative, conversion planning, optimization, and reporting in Hyderabad.",
  ...
  },
  {
    ...
    title: "SEO and local search that help Hyderabad customers find and trust you.",
    description: "SEO, local search optimization, Google Business Profile management, reputation support, and search content for Hyderabad businesses.",
