export const brand = {
  ...
  region: "",
  country: "IN",
  description: "PrysmNexus is an India-focused digital marketing agency combining brand strategy, original content, social media, performance marketing, SEO, local search, and reputation support under one accountable team.",
  reviewed: "2026-07-16",
};
